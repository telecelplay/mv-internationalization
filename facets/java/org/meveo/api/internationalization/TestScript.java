...
public class TestScript extends EndpointScript {
	...
	public void execute(Map<String, Object> parameters) throws BusinessException {
      ...
      Map<String, Object> context= new HashMap<>();
        Internationalizer internationalizer = Internationalizer.getInstance((EndpointScript)this, context);
        log.error("=================================================================");        
        ...
        String messsage = internationalizer.get("user.personal.introduction2", params );   
      
        
        log.error("messsage= "+messsage);
        log.error("=================================================================");
